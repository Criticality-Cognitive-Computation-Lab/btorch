...
from .kernels import coo_spmm_kernel, sddmm_kernel
...
class SparseCOOMatMul(torch.autograd.Function):
    ...
    def backward(ctx, grad_out):
        ...
        if nnz > 0:
            ...
            # Result (K, N).
            # IS_BOOL_FLOAT applies to B? In backward, B is Grad_C. Grad_C is float.
        ...
        #    grad_a_v[k] = dot(grad_out[row[k]], dense[col[k]])
