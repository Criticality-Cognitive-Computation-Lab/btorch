...
from benchmarks.glif_net.glif_common import _DT, make_inputs, providers
...
def _run_multistep_kernel(
    ...
    if provider == "triton":
        from benchmarks.glif_net.glif_triton import glif3_step_triton as step_fn
    elif provider == "warp":
        from benchmarks.glif_net.glif_warp import glif3_step_warp as step_fn
    elif provider == "cupy":
        from benchmarks.glif_net.glif_cupy import glif3_step_cupy as step_fn
    else:
